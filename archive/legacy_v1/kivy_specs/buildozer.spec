...
requirements = python3,kivy,colorama,android
...
#android.skip_update_options = False
...
# (str) python-for-android local directory setting (if empty, it will be downloaded)
#p4a.source_dir =
